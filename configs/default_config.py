...
########################################################################################################################
cfg.save = CN()
cfg.save.folder = 'depth'                    # Folder where data will be saved
cfg.save.depth = CN()
cfg.save.depth.rgb = False               # Flag for saving rgb images
cfg.save.depth.viz = True               # Flag for saving inverse depth map visualization
cfg.save.depth.npz = False               # Flag for saving numpy depth maps
cfg.save.depth.png = False               # Flag for saving png depth maps
########################################################################################################################
### WANDB
########################################################################################################################
cfg.wandb = CN()
...
cfg.datasets.validation.back_context = 1            # Validation backward context
cfg.datasets.validation.forward_context = 1         # Validation forward contxt
...
cfg.datasets.test.back_context = 1                  # Test backward context
cfg.datasets.test.forward_context = 1               # Test forward context
